...
//extern double solverNorm;

//-----------------------------------------------------------------------------
void pardisoSolver_deltaP()
//-----------------------------------------------------------------------------
{
   ...
   PARDISO (pt, &maxfct, &mnum, &mtype, &phase,
            &NN, val_deltaP, row_deltaP, col_deltaP, &idum,
            &nrhs, iparm, &msglvl, F_deltaP, pPrime, &error);
   ...
   phase = -1;
   PARDISO (pt, &maxfct, &mnum, &mtype, &phase,
            &NN, &ddum, row_deltaP, col_deltaP, &idum, &nrhs,
